...
I have taken the old version and added a few upgrades!  It is now a reusable game where the trivia can be switched out with a new Trivia object.  Layout is created using jQuery instead of staticly lurking in HTML.  

[see snippet of old html here](assets/images/oldhtml.png)
